...
export type ProfileResponse<Thours = unknown, Texpand = unknown> = Required<ProfileRecord<Thours>> & BaseSystemFields<Texpand>
export type SocialResponse<Texpand = unknown> = Required<SocialRecord> & BaseSystemFields<Texpand>
export type ThemeResponse<Texpand = unknown> = Required<ThemeRecord> & BaseSystemFields<Texpand>
export type UsersResponse<Texpand = unknown> = Required<UsersRecord> & AuthSystemFields<Texpand>
export type VodkaItemResponse<Texpand = unknown> = Required<VodkaItemRecord> & BaseSystemFields<Texpand>
export type WineItemResponse<Texpand = unknown> = Required<WineItemRecord> & BaseSystemFields<Texpand>
